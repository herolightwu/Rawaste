...
public class AnnouncementAdapter extends RecyclerView.Adapter<AnnouncementAdapter.ViewHolder> {
    ...
    public AnnouncementAdapter(Context context, List<Product> products, EventListener listener) {
    ...
    public AnnouncementAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        ...
        View v = LayoutInflater.from(viewGroup.getContext())
                .inflate(R.layout.item_anouncement, viewGroup, false);
    ...
    public void onBindViewHolder(@NonNull ViewHolder viewHolder, final int position) {
        ...
        viewHolder.btn_modify.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                if (listener != null) listener.onClickModify(position);
            }
        });
